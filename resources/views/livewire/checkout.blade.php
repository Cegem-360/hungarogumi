<div class="bg-gray-100 min-h-screen py-8">
    <div class="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div class="bg-white rounded shadow p-6 border-t-4 border-green-500">
            <h2 class="text-xl font-semibold mb-4 flex items-center gap-2">
                <span class="w-5 h-5 border-2 border-gray-400 rounded-full flex items-center justify-center mr-2">
                    <span class="bg-gray-400 w-2 h-2 rounded-full"></span>
                </span>
                Számlázási adatok
            </h2>
        ...
        <div class="bg-white rounded shadow p-6 border-t-4 border-green-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <label class="flex flex-col border rounded px-4 py-3 cursor-pointer hover:border-green-500">
                    <div class="flex items-center gap-2 mb-2">
                        <input type="radio" name="payment" class="mt-1" />
                        <span class="font-semibold">Átvételkor</span>
                    </div>
                ...
                <label class="flex flex-col border rounded px-4 py-3 cursor-pointer hover:border-green-500">
                    <div class="flex items-center gap-2 mb-2">
                        <input type="radio" name="payment" class="mt-1" />
                        <span class="font-semibold">Előreutalás</span>
                    </div>
                    <span class="text-xs text-gray-500">...</span>
                </label>
                <label class="flex flex-col border rounded px-4 py-3 cursor-pointer hover:border-green-500 col-span-2">
                    <div class="flex items-center gap-2 mb-2">
                        <input type="radio" name="payment" class="mt-1" />
                        <span class="font-semibold">Bankkártyás fizetés (Barion)</span>
                    </div>
                    <span class="text-xs text-gray-500 mb-2">...</span>
                    <div class="flex gap-2 items-center">
                        <img src="https://cdn.barion.com/pay/barion-barion.svg" alt="Barion" class="h-6">
                        <img src="https://cdn.barion.com/pay/barion-mastercard.svg" alt="Mastercard" class="h-6">
                        <img src="https://cdn.barion.com/pay/barion-visa.svg" alt="Visa" class="h-6">
                        <img src="https://cdn.barion.com/pay/barion-amex.svg" alt="Amex" class="h-6">
                        <img src="https://cdn.barion.com/pay/barion-applepay.svg" alt="Apple Pay" class="h-6">
                        <img src="https://cdn.barion.com/pay/barion-googlepay.svg" alt="Google Pay" class="h-6">
                    </div>
                </label>
            </div>
            <div class="flex items-center mt-4">
                <input type="checkbox" id="accept" class="mr-2">
                <label for="accept" class="text-sm">Elfogadom az <a href="#"
                        class="text-blue-600 underline">Adatkezelési tájékoztatóban</a> és a <a href="#"
                        class="text-blue-600 underline">Vásárlási feltételekben</a> leírtakat. <span
                        class="text-red-500">*</span></label>
            </div>
            <button
                class="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded mt-6 flex items-center justify-center gap-2 text-lg">
                Tovább az adatok ellenőrzéséhez
        ...
        <div class="w-full md:w-80 flex-shrink-0">
            <div class="bg-white rounded shadow p-6">
                ...
                <div class="flex items-center gap-3 mb-4">
                    <img src="https://www.ozracing.com/sites/default/files/styles/product/public/wheels/msw-78-fs-5x112-17x65-et49-66-6.jpg"
                        alt="MSW MSW 78 FS" class="w-16 h-16 object-contain border rounded" />
                    <div class="flex-1">
                        <div class="font-semibold text-sm leading-tight">MSW MSW 78 FS<br>5X112 17x6.5 ET49 66.6</div>
