            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="bg-white rounded shadow p-6 border-t-4 border-green-500">
                    ...
                    <div>
                        ...
                        <textarea wire:model.live="shippingComment" class="w-full border rounded px-3 py-2 bg-yellow-50"
                            placeholder="Megjegyzés"></textarea>
                        @error('shippingComment')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
                        ...
                        <div class="flex gap-2">
                            <div class="w-24">
                                ...
                                <input type="text" class="w-full border rounded px-3 py-2" placeholder="XXXX"
                                    required wire:model.live="billingZip" autocomplete="postal-code">
                                @error('billingZip')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
