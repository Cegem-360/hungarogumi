        ...
        <div class="grid md:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-300">
                    <li><a href="#" class="hover:text-white">Cégünkről</a></li>
                    <li><a href="#" class="hover:text-white">Elérhetőségek</a></li>
                    <li><a href="#" class="hover:text-white">Vásárlói panaszkezelés</a></li>
                    <li><a href="#" class="hover:text-white">Adatkezelési tájékoztató</a></li>
                    <li><a href="#" class="hover:text-white">Jótállás és garancia</a></li>
                    <li><a href="#" class="hover:text-white">Szállítási információk</a></li>
                    <li><a href="#" class="hover:text-white">ÁSZF</a></li>
                    <li><a href="#" class="hover:text-white">Fizetési módok</a></li>
                </ul>
            </div>
