            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div class="w-2/3">
                        ...
                        <p class="mb-4">Fedezd fel, hogyan mutat az autódon egy új MÁK alufelni – valósághű
                            látványtervben!</p>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div class="w-2/3">
                        ...
                        <p class="mb-4">Próbáld ki, hogyan állna egy OZ felni az autódon – kézzel fogható
                            vizualizációval!</p>
